class GoogleTranslate
  ...
  LANGUAGES = {
    ...
    "ca" => { name: "Catalan", source: true, target: true },
    ...
    "ky" => { name: "Kirghiz", source: true, target: true },
    ...
    "st" => { name: "Sotho", source: true, target: true },
